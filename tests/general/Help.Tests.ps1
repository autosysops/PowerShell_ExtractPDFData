...
Param (
	...
	[string[]]
	$CommandPath = @("$global:testroot\..\ExtractPDFData\functions", "$global:testroot\..\ExtractPDFData\internal\functions"),

	[string]
	$ModuleName = "ExtractPDFData",
...
$CommandPath = @(
    "$global:testroot\..\ExtractPDFData\functions"
    "$global:testroot\..\ExtractPDFData\internal\functions"
)
