...
Remove-Module ExtractPDFData -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\ExtractPDFData\ExtractPDFData.psd1"
Import-Module "$PSScriptRoot\..\ExtractPDFData\ExtractPDFData.psm1" -Force
